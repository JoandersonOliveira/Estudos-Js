 ...
 * o 'this.saudacao' na variavel para de apontar para o atributo "saudacao" do objeto 'pessoa'. Este conflito é solucionado com a função bind.
 */
...
//nota: o bind tem a função de fixar o this no contexto do objeto.